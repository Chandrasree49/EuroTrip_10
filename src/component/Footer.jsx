...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 mt-20" style={{background:"#F9F8F9"}}>
  <aside>
  <div className="flex">
          <div>
            <img
        ...
        <div>
          <p>The world is full of wonderful things you haven’t seen yet. Don’t ever give up on the chance of seeing them.</p>
        </div>
